...
urlpatterns = [
    ...
    path("appointments/<appointment_id>/update/", views.update_appointment, name="update_appointment"),
    ...
    path("reschedule_appointment/<appointment_id>/", views.reschedule_appointment, name="reschedule_appointment"),
